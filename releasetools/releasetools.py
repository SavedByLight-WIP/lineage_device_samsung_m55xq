...
def OTA_Assertions(info, input_zip):
  ...
  if m:
    ...
    cmd = ('assert(samsung_sm7450.verify_bootloader_min("{}") == "1" || abort("ERROR: This package requires Android 16 firmware. Please upgrade firmware (Only upto One UI 8 build CYL1, else your bootloader gets permanently locked) and retry!"););').format(bootloader_version)
