...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)rootdir/modules/recovery/modules.load:$(TARGET_COPY_OUT_RECOVERY)/root/lib/modules/modules.load
    $(call find-copy-subdir-files,*.ko,$(LOCAL_PATH)/rootdir/modules/recovery,$(TARGET_COPY_OUT_RECOVERY)/lib/modules)
